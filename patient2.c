...
#define PORT "21097" // the port of server
...
int main()
{
    ...
    printf("Phase 1: Patent 2 has TCP ");
    printownportnum();
    ...
    printf("Phase 1: Patient 2 anthentication result:%s\n",buf);
    ...
    {
      getport(bufdoc);
      printf("Phase 2: The requested appointment is availble and reserved to patient 2. The assigned doctor port is %s\n", port);
        close(sockfd);
    }
    ...
    printf("Phase 3: Patient 2 has a dynamic UDP ");
 ...
 /********send insurance*********/
    ...
    printownportnum();
    bufdoc[4]='\0';
    printf("Phase 3: The cost estimation request from Patient 2 with insurance plan %s has been sent to the doctor with port number %s and name %s.\n",loginbuf, port,bufdoc);
/***************receive price******************/
    int numbers;
